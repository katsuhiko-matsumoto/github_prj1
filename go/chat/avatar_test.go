...
func TestGravatarAvatar(t *testing.T) {
	...
	if err != nil {
		t.Error("GravatarAvatar.GetAvatarURL must not response error.")
	}
...
func TestFileSystemAvatar(t *testing.T) {
	...
	if err != nil {
		t.Error("TestFileSystemAvatar.GetAvatarURL must not response error.")
	}
	if url != "/avatars/abc.jpg" {
		t.Error("TestFileSystemAvatar.GetAvatarURL has returned wrong value: %s", url)
	}
}
